...
running  = createSprite(70,150);
running.addAnimation("SahilRunning",mainRacerImg1);
running.scale=0.07;
...
resert = createSprite(650,150);
resert.addImage(resertImg);
resert.scale = 0.8;
resert.visible = true;  
